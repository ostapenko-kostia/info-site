...
export function Hero() {
	return (
		<section className='w-full min-h-screen flex flex-col justify-center items-center relative gap-8 px-3'>
			<h1 className='text-6xl font-black text-center max-lg:text-5xl max-sm:text-3xl mix-blend-difference text-white'>
				Керуй командою легко.
			</h1>
			<p className='text-lg font-medium text-center max-w-2/3 max-sm:max-w-full max-sm:text-base mix-blend-difference text-white'>
			...
			<div className='flex flex-col items-center justify-center gap-2'>
				...
				<h2 className='text-xs font-medium text-center mix-blend-difference text-white'>
